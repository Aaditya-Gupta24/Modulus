...
def export_pdf_bytes(
    ...
    def _footer(canvas, doc):
        ...
        footer_text = f"Generated by MechOpt  |  {gen_time}"
    ...
    story.append(Paragraph("MechOpt Design Screening Report", title_style))
    ...
    disclaimers = [
        "This report is produced by MechOpt, a first-pass mechanical design screening tool "
